...
const Tokenomics = () => {
  return (
    ...
    <div className="text-white  bg-gradient-to-b from-[#529bd0]/90  to-white/60 items-center self-center lg:gap-0 gap-2 grid grid-cols-1 lg:grid-cols-2  w-full p-6 text-center max-w-[1280px] min-h-[546px] backdrop-blur-lg  rounded-4xl border-primary">
      <div className="flex items-start gap-6 justify-center min-h-[370px] flex-col">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
          <div className=" relative flex justify-start items-center text-black bg-white max-w-[290px] min-h-[44px] w-full rounded-lg shadow-md">
